    ...
    <div className="flex w-fit items-center gap-2.5">
      <span aria-hidden className="grid grid-cols-[repeat(3,4px)] gap-[1.5px]">
        {delays.map((d, i) => (
          <span
            key={i}
            className={`w-[4px] h-[4px] bg-tgb-gold ${round ? "rounded-full" : "rounded-[1px]"}`}
            style={{
      ...
      <span
        ...
        style={{
          backgroundImage:
            "linear-gradient(90deg, rgba(201, 154, 62, 0.4) 35%, rgba(226, 189, 105, 1) 50%, rgba(201, 154, 62, 0.4) 65%)",
